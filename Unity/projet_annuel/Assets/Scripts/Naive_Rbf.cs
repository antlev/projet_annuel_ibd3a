...
public class Naive_Rbf : MonoBehaviour {
	...
	public void createRbf(){
		...
		if (model == System.IntPtr.Zero) {
			...
			model = LibWrapperMachineLearning.createNaiveRbfModel (baseApprentissage.Length, gamma, inputs, inputSize, expectedOutputs);
